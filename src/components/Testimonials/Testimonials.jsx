        ...
        <div className="inner">
          <div className="div1 eachdiv">
            ...
            <div className="review dark">
              <p>
                Дуже вдячна❤️ програма дуже добре продумана, всі конспекти під
                носом, і найбільше подобається, як Алекс пояснює, в школі було
                тупо. Я зараз вчила все заново, а не згадувала. Думаю, якби в
                мене було більше вільного часу, щоб займатись, було б набагато
                краще. Чесно сказати, якби не цей курс, я б склала десь на 100
                максимум. Такі завдання, шо просто так не вгадаєш і не
                додумаєшся сам. А школу я закінчила ще в 2015, та й то нічого не
                знала з математики😅 А так аж соромно казати бал😅 але я ж кажу,
                без цього я б не здала 100% А так маю прохідний бал на
                «Медицину» Дякуююю
              </p>
            </div>
          </div>
